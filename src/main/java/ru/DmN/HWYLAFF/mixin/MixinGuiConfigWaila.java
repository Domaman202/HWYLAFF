...
public abstract class MixinGuiConfigWaila extends GuiOptions {
    ...
    public OptionsListWidget getOptions() {
        ...
        options.add(new OptionsEntryButton(Util.createTranslationKey("config", new Identifier("waila", "general")), new ButtonWidget(0, 0, 100, 20, new LiteralText(""), (w) -> {
            this.client.openScreen(new Anon2GuiOptions(this, new TranslatableText(Util.createTranslationKey("config", new Identifier("waila", "general")))));
        })));
        options.add(new OptionsEntryButton(Util.createTranslationKey("config", new Identifier("waila", "overlay")), new ButtonWidget(0, 0, 100, 20, new LiteralText(""), (w) -> {
            this.client.openScreen(new Anon3GuiOptions(this, new TranslatableText(Util.createTranslationKey("config", new Identifier("waila", "overlay"))), (GuiConfigWaila) (Object) this));
        })));
        options.add(new OptionsEntryButton(Util.createTranslationKey("config", new Identifier("waila", "formatting")), new ButtonWidget(0, 0, 100, 20, new LiteralText(""), (w) -> {
            this.client.openScreen(new Anon4GuiOptions(this, new TranslatableText(Util.createTranslationKey("config", new Identifier("waila", "overlay")))));
        })));
        return options;
    }
}
